...
apiPublicKey = 'PKVPYMI47PGIOY028HBO'
apiPrivateKey = 'N5TeiWQlaL9cZgEy7a4HAy15xJZ14lrNcJkIuhy9'
...
def candleStickTrader():
    stockDataCSV = pd.DataFrame(columns=['Stock',
